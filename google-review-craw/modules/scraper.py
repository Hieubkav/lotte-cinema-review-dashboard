...
class GoogleReviewsScraper:
    ...
    def scrape(self):
        ...
        sort_by = self.config.get("sort_by", "newest")
        ...
        log.info(f"URL: {url}")
        self._report_progress("navigating", f"Connecting to location...", url=url)
        ...
        try:
            ...
            if stop_threshold > 0 and sort_by != "newest":
                log.info("Disabling early stop — sort_by is not 'newest'")
                stop_threshold = 0
